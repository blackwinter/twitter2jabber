# -*- encoding: utf-8 -*-
# stub: twitter2jabber 0.8.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.licenses = ["AGPL-3.0"]
  s.post_install_message = "\ntwitter2jabber-0.8.2 [2014-04-28]:\n\n* Handle NullObject in example templates.\n\n"
  s.rdoc_options = ["--title", "twitter2jabber Application documentation (v0.8.2)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
