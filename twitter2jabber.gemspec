# -*- encoding: utf-8 -*-
# stub: twitter2jabber 0.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.licenses = ["AGPL"]
  s.rdoc_options = ["--charset", "UTF-8", "--line-numbers", "--all", "--title", "twitter2jabber Application documentation (v0.7.0)", "--main", "README"]
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<xmpp4r-simple-19>, [">= 0"])
      ...
      s.add_dependency(%q<xmpp4r-simple-19>, [">= 0"])
