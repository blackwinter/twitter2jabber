# -*- encoding: utf-8 -*-
# stub: twitter2jabber 0.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["COPYING", "ChangeLog", "README", "Rakefile", "TODO", "bin/twitter2jabber", "example/config.yaml", "example/templates/tweet.html", "example/templates/tweet.txt", "lib/twitter2jabber.rb", "lib/twitter2jabber/cli.rb", "lib/twitter2jabber/jabber.rb", "lib/twitter2jabber/twitter.rb", "lib/twitter2jabber/version.rb"]
  ...
  s.rdoc_options = ["--title", "twitter2jabber Application documentation (v0.8.0)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
