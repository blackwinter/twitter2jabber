...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/twitter2jabber.rb", "lib/twitter2jabber/version.rb", "bin/twitter2jabber", "README", "ChangeLog", "Rakefile", "TODO", "COPYING", "sample/templates", "sample/templates/tweet.txt", "sample/templates/tweet.html", "sample/config.yaml"]
  s.homepage = %q{http://twitter2jabber.rubyforge.org/}
  s.rdoc_options = ["--charset", "UTF-8", "--title", "twitter2jabber Application documentation", "--main", "README", "--line-numbers", "--inline-source", "--all"]
  s.require_paths = ["lib"]
